...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::materials::get_subject_lectures,
            commands::materials::create_subject_lecture,
            commands::materials::update_subject_lecture,
            commands::materials::delete_subject_lecture,
            ...
            commands::data_io::preview_section_excel_import,
            commands::data_io::import_section_excel,
